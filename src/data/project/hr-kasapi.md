...
summary: A centralized employee information and attendance system connected to
  payroll across branches and group companies.
role: System Design, Development, Database Design
featured: true
techStack:
  - VB.NET
  - MySQL
  - Crystal Reports
image: /images/projects/hr-kasapi-dashboard.png
gallery:
...
The system was structured around a clear employee record model so HR information could be maintained once and reused by connected payroll processes.
